 ...
 */
@property(nonatomic, strong, readonly) NSNumber *frameType;
...
/**
 * Given the service data for a frame we know to be a URL frame, create a new ESSBeaconInfo object to
 * represent this Eddystone
 */
